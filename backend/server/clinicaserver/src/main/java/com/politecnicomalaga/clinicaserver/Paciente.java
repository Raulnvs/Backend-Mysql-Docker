...
public class Paciente {
    ...
    public Paciente(String sCSV) {
        ...
        // Me vendrá una línea mínimo para el paciente
        ...
        // Si hay más de una línea, hay tratamientos
        for (int i = 1; i < lineas.length; i++) {
            // Trabajamos en el tratamiento
    ...
    public boolean compara(String campo, AtributosPaciente at) {
        switch (at) {
            case NOMBRE:
                return this.sNombre.contains(campo);
            case APELLIDOS:
                return this.sApellidos.contains(campo);
            case DNI:
                return this.sDni.contains(campo);
            case FNAC:
                return this.sFNac.contains(campo);
            case EMAIL:
                return this.sEmail.contains(campo);
            case TFNO:
                return this.sTelefono.contains(campo);
        }
        return false;
    }
    ...
    public void setValor(String campo, AtributosPaciente at) {
        switch (at) {
            case NOMBRE:
                this.setsNombre(campo);
                break;
            case APELLIDOS:
                this.setsApellidos(campo);
                break;
            case DNI:
                this.setsDni(campo);
                break;
            case FNAC:
                ...
                break;
            case EMAIL:
                this.setsEmail(campo);
                break;
            case TFNO:
                this.setsTelefono(campo);
                break;
        }
    }
